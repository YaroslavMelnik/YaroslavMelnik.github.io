	...
	new Swiper('.slider-header', {
		...
		pagination: {
			...
			renderBullet: function (index, className) {
				return '<span class="' + className + '">Slide # ' + (index + 1) + '</span>';
			},
		...
		// Arrows
		navigation: {
			nextEl: '.slider-header .slider-arrow_next',
			prevEl: '.slider-header .slider-arrow_prev',
		}
	});
}
...
if (document.querySelector('.infr-slider')) {
	new Swiper('.infr-slider', {
		observer: true,
		observeParents: true,
		slidesPerView: 1,
		spaceBetween: 0,
		...
		// Dotts
		pagination: {
			el: '.infr-dots-container',
			clickable: true,
		},
		// Arrows
		navigation: {
			nextEl: '.infr-slider .slider-arrow_next',
			prevEl: '.infr-slider .slider-arrow_prev',
		}
	});
}
...
window.onload = function () {
	...
	outNum(355, "#info-header__num-1");
	outNum(185, "#info-header__num-2");
	outNum(210, "#info-header__num-3");
